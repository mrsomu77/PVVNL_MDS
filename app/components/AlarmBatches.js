// app/components/AlarmBatches.js
"use client";
...
export default function AlarmBatches() {
  ...
  const fetchStatus = async () => {
    setLoading(true);
    try {
      const res = await fetch("/api/alarm-status", { method: "POST" });
